...
A delightful saved-game hacker for Timber and Stone.
...
2. If it doesn't run, install the "Microsoft Visual C++ 2010 Redistributable Package", located here: http://www.microsoft.com/en-us/download/details.aspx?id=5555
...
-----------------
Tested with Beta 0.2

I got it to work on Windows 7, 32 and 64 bit. There is ONE dependancy that you need to have installed (and you probably already have it): it's called "Microsoft Visual C++ 2010 Redistributable Package". You can download it here: http://www.microsoft.com/en-us/download/details.aspx?id=5555
